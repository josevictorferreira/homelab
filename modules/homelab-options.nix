...
let
  ...
  nodesConfigType = t.submodule {
    options = {
      hosts = mkOption { type = t.attrsOf nodeHostsTypea; description = "Map of all node host configurations."; };
  ...
  usersConfigType = mkOptions { type = t.attrsOf userType; description = "Map of all user configurations."; };
  ...
  kubernetesConfigType = t.submodule {
    options = {
      ...
      namespaces = mkOption { type = t.listOf t.str; description = "List of Kubernetes namespaces to create."; default = [ "default" "kube-system" "kube-public" ]; };
    ...
    options = {
      ...
      paths = t.submodule {
        options = {
          ...
          kubernetes = mkOption { type = t.str; description = "Path to Kubernetes configuration."; };
