    ...
    resources = {
      secrets."valoris-config" = {
        ...
        stringData = {
          ...
          "VALORIS_DATABASE_HOST" = kubenix.lib.postgresHost;
          ...
          "LLM_PROVIDER" = "velox";
          "LLM_BASE_URL" = "http://${kubenix.lib.serviceHostFor "velox" namespace}:8080/v1/chat/completions";
          "LLM_API_KEY" = kubenix.lib.secretsFor "velox_api_keys";
          "LLM_MODEL" = "pippin";
          "LLM_TIMEOUT_SECONDS" = "180";
          "LLM_MAX_RETRIES" = "3";
          "LLM_FALLBACK_BASE_URL" = "http://${kubenix.lib.serviceHostFor "velox" namespace}:8080/v1/chat/completions";
          "LLM_FALLBACK_API_KEY" = kubenix.lib.secretsFor "velox_api_keys";
          "LLM_FALLBACK_MODEL" = "pippin";
        };
      };
    };
  };
