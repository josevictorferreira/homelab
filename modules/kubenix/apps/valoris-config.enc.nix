    ...
    resources = {
      secrets."valoris-config" = {
        ...
        stringData = {
          ...
          "LLM_BASE_URL" = "http://omniroute.apps.svc.cluster.local:20128/v1/chat/completions";
          "LLM_API_KEY" = kubenix.lib.secretsFor "omniroute_api_key";
          "LLM_MODEL" = "pippin";
          "LLM_TIMEOUT_SECONDS" = "180";
          "LLM_MAX_RETRIES" = "3";
          "LLM_FALLBACK_BASE_URL" = "http://omniroute.apps.svc.cluster.local:20128/v1/chat/completions";
          "LLM_FALLBACK_API_KEY" = kubenix.lib.secretsFor "omniroute_api_key";
