...
let
  ...
  appImage = {
    ...
    tag = "v2026.4.22@sha256:6e1a3617237aa01750ac5118baae020335e34870ec51ecb138f3ff948d3409df";
    pullPolicy = "Always";
  };
in
{
            ...
            main = {
              ...
              command = [
                ...
                ''
                  ...
                  ALLOWLIST="OPENCLAW_MATRIX_TOKEN ELEVENLABS_API_KEY KIMI_API_KEY OPENROUTER_API_KEY OPENAI_API_KEY MINIMAX_API_KEY Z_AI_API_KEY ALIBABA_CODING_PLAN_API_KEY WHATSAPP_NUMBER WHATSAPP_BOT_NUMBER GEMINI_API_KEY GITHUB_TOKEN TS_AUTHKEY KIRA_MATRIX_TOKEN LUNA_MATRIX_TOKEN MEL_MATRIX_TOKEN SPIKE_MATRIX_TOKEN COPILOT_GITHUB_TOKEN"
