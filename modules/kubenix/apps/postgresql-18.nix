...
let
  ...
  mkCreateDb = db: ''
        ...
        psql -h postgresql-18 -U postgres -d ${db} -c "DROP EXTENSION IF EXISTS vectors;CREATE EXTENSION IF NOT EXISTS vchord CASCADE;" || echo "Extension installation completed for ${db}"
  '';
  ...
  jobName = "postgresql-18-bootstrap-${builtins.substring 0 8 configChecksum}";
in
{
  kubernetes = {
