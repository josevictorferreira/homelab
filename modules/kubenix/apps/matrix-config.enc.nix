        ...
        "mautrix-whatsapp-config" = {
          ...
          stringData = {
            "config.yaml" = kubenix.lib.toYamlStr {
              ...
              database = {
                type = "postgres";
                uri = "postgres://postgres:${kubenix.lib.secretsInlineFor "postgresql_admin_password"}@${kubenix.lib.postgresHost}:5432/mautrix_whatsapp_v2?sslmode=disable";
                max_open_conns = 20;
                max_idle_conns = 2;
          ...
          stringData = {
            "config.yaml" = kubenix.lib.toYamlStr {
              ...
              appservice = {
                ...
                database = {
                  type = "postgres";
                  uri = "postgres://postgres:${kubenix.lib.secretsInlineFor "postgresql_admin_password"}@${kubenix.lib.postgresHost}:5432/mautrix_discord_v2?sslmode=disable";
                };
              };
              bridge = {
        ...
        "mautrix-slack-config" = {
          ...
          stringData = {
            "config.yaml" = kubenix.lib.toYamlStr {
              ...
              database = {
                type = "postgres";
                uri = "postgres://postgres:${kubenix.lib.secretsInlineFor "postgresql_admin_password"}@${kubenix.lib.postgresHost}:5432/mautrix_slack_v2?sslmode=disable";
              };
